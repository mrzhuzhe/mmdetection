...
train_pipeline = [
    ...
    #dict(type='Resize', img_scale=[(2240, 1260), (2432, 1368), (2560, 1440), (2752, 1548)], keep_ratio=True),    
    # only low and high
    dict(type='Resize', img_scale=[(2240, 1260), (2752, 1548)], keep_ratio=True),    
...
test_pipeline = [
    ...
    dict(
        ...
        #img_scale=(2560, 1440),
        #img_scale=[(2240, 1260), (2432, 1368), (2560, 1440), (2752, 1548), (2880, 1620)],
        img_scale=[(2560, 1440), (2752, 1548), (2880, 1620)],
        flip=True,
...
nx = 1
work_dir = f'./work_dirs/reef/cascade-r50-large-multiscaleTrain'
evaluation = dict(
    classwise=True,
    interval=1,
    metric=['bbox'],
